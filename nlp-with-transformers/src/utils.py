...
def setup_task():
  ...
  if not is_gpu_available:
    print("No GPU was detected! For faster execution, please get a GPU, else it will be slow 🐢")
    if is_colab:
      print("Go to Runtime > Change runtime type and select a GPU hardware accelerator.")
  
  # Displaying versions of the core libraries
